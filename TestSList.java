...
public class TestSList {
	 /**
	  ...
	  public static void main (String[] args) {
		...
		SList newList = new SList();//creates an sList object

		newList.insertFront(new Integer (12));//adds 12 to front
		newList.insertFront(new Integer(9));//adds 9 to front
		newList.insertFront(new Integer(6));//adds 6 to front
		
		//System.out.println("This will print [  6  9  12  ]");
		System.out.println(newList.toString());//prints to screen

		newList.insertEnd(new Integer(15));//adds 15 to the end
		newList.insertFront( new Integer(3));//adds 3 to the front

		//System.out.println("This will print [  3  6  9  12  15  ]");
		System.out.println(newList.toString());//prints to screen
